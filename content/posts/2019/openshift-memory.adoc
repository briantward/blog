...
Cgroups, cAdvisor, heapster, and docker 

master API health stats/summary
-----------------------------------------------
curl -k -H "Authorization: Bearer <redacted>" https://127.0.0.1:10250/stats/summary
...
emory.stat file includes following statistics
